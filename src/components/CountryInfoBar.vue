        ...
        >
          ...
          <v-list-item v-if="checkIndicator('key-wdi2-SP.POP.TOTL')">
            <v-list-item-content class="one-line">
              <v-list-item-title
                class="one-line_header"
                v-text="indicatorsMetadata['key-wdi2-SP.POP.TOTL'].indicator"
              ></v-list-item-title>
              <v-list-item-subtitle>{{
                nFormatter(getIndicator("key-wdi2-SP.POP.TOTL").value)
              }}</v-list-item-subtitle>
            </v-list-item-content>
          </v-list-item>
          ...
          <v-list-item v-if="checkIndicator('key-wdi-AG.SRF.TOTL.K2')">
            <v-list-item-content class="one-line">
              <v-list-item-title
                class="one-line_header"
                v-text="indicatorsMetadata['key-wdi-AG.SRF.TOTL.K2'].indicator"
              ></v-list-item-title>
              <v-list-item-subtitle
                >{{
                  nFormatter(getIndicator("key-wdi-AG.SRF.TOTL.K2").value)
                }}
                km<sup>2</sup></v-list-item-subtitle
              >
            </v-list-item-content>
          </v-list-item>
