//FUNCTIONALITY OF THE RIGHTHAND SIDEBAR
...
function addLayer() {
  ...
  document.getElementsByClassName("calc-function")[0].innerHTML =
    document.getElementsByClassName("calc-function")[0].innerHTML + count;
  ...
  document.getElementById("layers").innerHTML =
    document.getElementById("layers").innerHTML +
    `<div class="row-flex space-between align-items-center" id='` +
    count +
    `-layer' style="height:30px;width:340px;background-color:#DFDFDF;margin-top:6px; border-radius:5px;">
     <div class="row-flex align-items-center" style="margin: 0 10px;">
       <i class='layers-value'>` +
    variable +
    `</i>
       <select name="` +
    count +
...
//this function is currently not used -- uses the boundary one I made - SEBASTIAN NOTE
...
function calcButtonPress(val) {
  document.getElementsByClassName("calc-function")[0].innerHTML =
    document.getElementsByClassName("calc-function")[0].innerHTML + val;
}
...
//my generalized toggleXMenu function
